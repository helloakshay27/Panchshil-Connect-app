...
const LockFunctionEdit = () => {
  ...
  if (
    formData.parent_function &&
    !parentFunctionOptions.some(
      (option) => String(option.value) === String(formData.parent_function)
    )
  ) {
    parentFunctionOptions.push({
      label: formData.parent_function,
