...
const Tiers = () => {
  ...
  const columns = [
    { key: "name", label: "Tier Name", render: (tier) => tier.name || "-" },
    { key: "exit_points", label: "Exit Points" },
    {
      key: "multipliers",
      label: "Multipliers",
      render: (tier) => `${tier.multipliers}x`,
    },
    {
      key: "welcome_bonus",
      label: "Welcome Bonus",
      render: (tier) => `${tier.welcome_bonus} Points`,
    },
    {
      key: "member_count",
      label: "Member Count",
      render: (tier) => tier.member_count || 0,
    },
    {
      key: "edit",
      label: "Edit",
            ...
            <div className="card-body">
              ...
              <div className="loyalty-header">
                ...
                <EnhancedTable
                  ...
                  data={filteredItems}
                  loading={loading}
                  emptyMessage={error || "No tiers found"}
                  searchTerm={searchTerm}
                  onSearchChange={handleSearchInputChange}
                  onSearchSubmit={handleSearch}
                  searchPlaceholder="Search by Tier name"
                  currentPage={currentPage}
                  pageSize={itemsPerPage}
                  onPageChange={handlePageChange}
                  getRowId={(tier) => tier.id}
                  storageKey="tier-list"
                />
                {showLegacyTable && (
                  <>
                    <div
                                ...
                                <tr key={tier.id}>
                                  ...
                                  <td>
                                    <button
                                      ...
                                      onClick={() =>
                                        navigate(
                                          `/setup-member/tier-details/${tier.id}`,
                                        )
                                      }
                                      title="View Tier"
                                    >
                            ...
                            {searchTerm ? (
                              <>
                                <div style={{ marginBottom: "8px" }}>
                                  No tiers found matching your search.
                                </div>
                  ...
                  <div className="modal-dialog" role="document">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h5 className="modal-title" id="editTierModalLabel">
                          Edit Tier
                        </h5>
                        <button
                          type="button"
