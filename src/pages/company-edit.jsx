...
const CompanyEdit = () => {
    ...
    const fetchCompany = async () => {
        try {
            const response = await axios.get(`https://panchshil-super.lockated.com/company_setups/${id}.json`, {
                headers: {
    ...
    const fetchOrganizations = async () => {
        try {
            const response = await axios.get(`https://panchshil-super.lockated.com/organizations.json`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('access_token')}`
                }
            })
