        ...
        <div className="module-data-section container-fluid">
          <div className="d-flex justify-content-end px-4 pt-2 mt-3">
            ...
            <div className="card-tools mt-1">
              ...
              >
                <svg width={26} height={20} fill="currentColor" className="bi bi-plus">
          ...
          <div className="card mx-3 mt-4">
            <div className="card-header">
              <h3 className="card-title">Construction Status List</h3>
            </div>
                        ...
                        .map((status, index) => (
                          <tr key={status.id}>
                            ...
                            <td>
                              <button
                                onClick={() =>
                                  handleToggle(status.id, status.active)
                                }
                            ...
                            <td>
                              <button
                                ...
                                onClick={() =>
                                    navigate(`/construction-status-edit/${status.id}`)
                                }
                              >
                                <svg
                                xmlns="http://www.w3.org/2000/svg"
