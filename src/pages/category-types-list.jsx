  ...
  const handleToggle = (id, currentStatus) => {
    ...
    axios
      .put(`https://panchshil-super.lockated.com/category_types/${id}.json`, {
        category_type: { active: newStatus }, // Ensuring boolean value is passed
      })
      .then(() => {
        fetchCategories(); // Refresh list after toggle
      })
    ...
    <div className="main-content">
      <div className="website-content overflow-auto">
        <div className="module-data-section container-fluid">
          <div className="d-flex justify-content-end px-4 pt-2 mt-3"></div>
                        ...
                        <tr key={category.id}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() =>
                                navigate(
                                  `/setup-member/category-types-edit/${category.id}`
                                )
                              }
                              style={{
                                background: "none",
