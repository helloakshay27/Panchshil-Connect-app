...
const UserGroupList = () => {
  ...
  const getPageFromStorage = () => {
    return parseInt(localStorage.getItem("usergroup_list_currentPage")) || 1;
  };
  ...
  const getUserPermission = () => {
    try {
      ...
      return permissions.usergroup || {}; // Fetching usergroup-specific permissions
    } catch (e) {
  ...
  const filteredUserGroups = userGroups.filter(
    (usergroup) =>
      ...
      usergroup.company_id?.toString().includes(searchQuery.toLowerCase()) ||
      usergroup.site_id?.toString().includes(searchQuery.toLowerCase())
  );

  const displayedUserGroups = filteredUserGroups.slice(
            ...
            >
              <div className="input-group">
                <input
                  ...
                  placeholder="Search by name, company ID, or site ID"
                  fdprocessedid="u38fp"
                  value={searchQuery}
        ...
        <div className="module-data-section container-fluid">
          <div className="card mt-4 pb-4 mx-3">
            <div className="card-header">
              <h3 className="card-title">User Groups List</h3>
            </div>
                ...
                <>
                  <div className="tbl-container mt-3">
                    <table className="w-100">
                      ...
                      <tbody>
                        {displayedUserGroups.length === 0 ? (
                          <tr>
                            <td colSpan="8">No user groups found.</td>
                          </tr>
                        ) : (
                          displayedUserGroups.map((usergroup, index) => (
                            <tr key={usergroup.id}>
                              <td>
