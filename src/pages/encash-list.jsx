...
const EncashList = () => {
  ...
  const columns = [
    ...
    {
      key: "points_to_encash",
      label: "Points",
      render: (request) => request.points_to_encash.toLocaleString(),
    },
    {
      key: "facilitation_fee",
      label: "Fee",
      render: (request) => formatCurrency(request.facilitation_fee),
    },
    {
      key: "amount_payable",
      label: "Amount",
      render: (request) => formatCurrency(request.amount_payable),
    },
      ...
      render: (request) => (
        <select
          ...
          style={{
            ...
            padding: "4px 8px",
            backgroundColor:
              request.status === "completed" ? "#d4edda" : "#fff3cd",
            border:
            ...
            <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                  <div className="input-group me-3">
                    ...
                    {suggestions.length > 0 && (
                      <ul
                        className="search-suggestions position-absolute"
                        style={{
                          top: "100%",
                          left: "0",
                          width: "100%",
              ...
              >
                <EnhancedTable
                  ...
                  data={filteredItems}
                  loading={loading}
                  emptyMessage={error || "No encash requests found"}
                  ...
                  storageKey="encash-request-list"
                />
                {showLegacyTable ? (
                  <>
                          ...
                          {currentItems.map((request) => (
                            <tr key={request.id}>
                              ...
                              <td style={{ textAlign: "right" }}>
                                {request.points_to_encash.toLocaleString()}
                              </td>
                              <td style={{ textAlign: "right" }}>
                                {formatCurrency(request.facilitation_fee)}
                              </td>
                              <td style={{ textAlign: "right" }}>
                                {formatCurrency(request.amount_payable)}
                              </td>
                  ...
                  {selectedRequest && (
                    <div>
                      <div className="mb-3">
                        ...
                        <p>
                          <strong>Person:</strong> {selectedRequest.person_name}
                        </p>
                        <p>
                          <strong>Points:</strong>{" "}
                          {selectedRequest.points_to_encash.toLocaleString()}
                        </p>
                        <p>
                          <strong>Amount Payable:</strong>{" "}
                          {formatCurrency(selectedRequest.amount_payable)}
                        </p>
                        <p>
