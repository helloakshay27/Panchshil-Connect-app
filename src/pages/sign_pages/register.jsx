                            ...
                            <div className="col-lg-7 col-md-7 vh-50 d-flex align-items-center">
                                <div className="login-sec">
                                    ...
                                    />
                                        ...
                                        <form onSubmit={handlePasswordLogin} className="mt-2 login-content" style={{ width: "260px" }}>
                                          
                                            <div className="form-group position-relative">
                                                <label className="mb-1" htmlFor="email">firstname</label>
                                                <input
                                                    type="text"
                                                    id="email"
                                            ...
                                            <div className="form-group position-relative">
                                                <label className="mb-1" htmlFor="password">lastname</label>
                                                <input
                                                    type="text"
                                                    id="password"
