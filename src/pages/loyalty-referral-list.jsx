...
const LoyaltyReferralList = () => {
  ...
  const columns = [
    ...
    { key: "name", label: "Name", render: (referral) => referral.name || "-" },
    {
      key: "email",
      label: "Email",
      render: (referral) => referral.email || "-",
    },
    {
      key: "mobile",
      label: "Mobile No",
      render: (referral) => referral.mobile || "-",
    },
    {
      key: "referral_code",
      label: "Referral Code",
      render: (referral) => referral.referral_code || "N/A",
    },
    {
      key: "project_name",
      label: "Project Name",
      render: (referral) => referral.project_name || "-",
    },
  ];
          ...
          <div className="card-body">
            ...
            >
              <EnhancedTable
                ...
                loading={loading}
                emptyMessage={error || "No referrals found"}
                ...
                storageKey="loyalty-referral-list"
              />
              {showLegacyTable && (
                <>
                  <table
