...
const ProjectDetailsCreate = () => {
  ...
  const handleCreativeImageUpload = (event, type) => {
    ...
    const updatedImages = files.map((file) => ({
      creative_image: file,
      creative_image_file_name: file.name,
      creative_type: selectedCreativeType,
    }));
    setFormData((prev) => ({
      ...prev,
  ...
  const handleQRCodeImageNameChange = (index, newName) => {
    setFormData((prev) => {
      ...
      updatedImages[index].title = newName;
                ...
                <div className="form-group">
                  ...
                  <SelectBox
                    ...
                    onChange={(selectedOption) =>
                      setFormData((prev) => ({
                        ...prev,
                        Project_Construction_Status: selectedOption,
                      }))
                    }
                  />
                </div>
                ...
                <div className="form-group">
                  <button
                    onClick={() =>
                      setFormData((prev) => ({
                        ...prev,
                        enable_enquiry: !prev.enable_enquiry,
                      }))
                    }
              ...
              <div className="d-flex justify-content-between align-items-end mx-1">
                <h5 className="mt-3">
                  ...
                  >
                    ...
                    {showTooltip && (
                      <span className="tooltip-text">
                        Max Upload Size 3 MB (Images), 10 MB (Videos) and Required ratio is 16:9
                      </span>
                    )}
                  </span>
                </h5>
                ...
                {/* MODIFICATION: Use ProjectImageVideoUpload for the gallery */}
                {showGalleryModal && (
                  <ProjectImageVideoUpload
