...
const ACTIVE_USERS_TREND = [
  { label: "Jul 22", count: 52 }, { label: "Jul 23", count: 58 }, { label: "Jul 24", count: 61 },
  { label: "Jul 25", count: 49 }, { label: "Jul 26", count: 66 }, { label: "Jul 27", count: 71 },
  { label: "Jul 28", count: 64 }, { label: "Jul 29", count: 69 }, { label: "Jul 30", count: 75 },
  { label: "Jul 31", count: 80 }, { label: "Aug 1", count: 73 }, { label: "Aug 2", count: 78 },
  { label: "Aug 3", count: 85 }, { label: "Aug 4", count: 91 }, { label: "Aug 5", count: 88 },
  { label: "Aug 6", count: 94 }, { label: "Aug 7", count: 99 }, { label: "Aug 8", count: 90 },
  { label: "Aug 9", count: 96 }, { label: "Aug 10", count: 101 }, { label: "Aug 11", count: 97 },
  { label: "Aug 12", count: 104 }, { label: "Aug 13", count: 108 }, { label: "Aug 14", count: 102 },
];
...
const ADOPTION_TILES = [
  { label: "Seat Utilisation", value: "24%", sub: "active ÷ registered residents" },
  { label: "Stickiness", value: "26%", sub: "avg DAU / MAU" },
  { label: "Adoption Trend", value: "+7%", sub: "vs prior 8 weeks · weekly actives" },
  { label: "14-Day Activation", value: "33%", sub: "of new registrations" },
  { label: "Module Breadth", value: "13 / 20", sub: "modules used this period" },
];

const ADOPTION_TREND = [
  { label: "W1", count: 62 }, { label: "W2", count: 66 }, { label: "W3", count: 69 },
  { label: "W4", count: 73 }, { label: "W5", count: 76 }, { label: "W6", count: 80 },
  { label: "W7", count: 84 }, { label: "W8", count: 89 },
];
...
const SITE_WISE = [
  { project: "Panchshil Towers – Kharadi", active: 58, sessions: 102, avgSession: "2.6m", bounce: 17, trend: "up", status: "Healthy" },
  { project: "Panchshil Business Park – Yerwada", active: 41, sessions: 74, avgSession: "2.1m", bounce: 22, trend: "flat", status: "Steady" },
  { project: "Panchshil Residency – Hinjewadi", active: 33, sessions: 55, avgSession: "1.9m", bounce: 26, trend: "up", status: "Steady" },
  { project: "Panchshil Greens – Bavdhan", active: 19, sessions: 29, avgSession: "1.6m", bounce: 31, trend: "dn", status: "Watch" },
];
...
const WORKFLOWS = [
  { key: "auth", name: "Auth & Onboarding", bucket: "Access", steps: ["splash_viewed", "login_screen_viewed", "auth_otp_requested", "otp_screen_viewed", "auth_otp_verified_success", "auth_login_success"], adoption: 94, completionRate: 85, completions: 92 },
  { key: "home", name: "Home Dashboard", bucket: "Access", steps: ["home_page_viewed", "home_banner_viewed", "home_banner_tapped", "home_quick_action_tapped", "home_section_viewed"], adoption: 82, completionRate: 71, completions: 71 },
  { key: "connect", name: "Panchshil Connect", bucket: "Access", steps: ["connect_tab_viewed", "home_tab_viewed", "connect_section_tapped", "connect_banner_tapped", "bottom_nav_tapped"], adoption: 64, completionRate: 60, completions: 44 },
  { key: "switcher", name: "Project Switcher", bucket: "Access", steps: ["project_selection_viewed", "project_switched"], adoption: 88, completionRate: 81, completions: 58 },
  { key: "profile", name: "Profile & Settings", bucket: "Access", steps: ["profile_viewed", "profile_edit_opened", "profile_updated"], adoption: 42, completionRate: 66, completions: 27 },
  { key: "account", name: "My Account & Financials", bucket: "Account & Money", steps: ["account_overview_viewed", "booking_details_viewed", "demand_letter_viewed", "payment_status_checked", "ncf_accepted", "stamp_duty_viewed"], adoption: 71, completionRate: 44, completions: 34 },
  { key: "applicant", name: "Primary Applicant", bucket: "Account & Money", steps: ["primary_applicant_viewed", "primary_applicant_section_expanded"], adoption: 31, completionRate: 69, completions: 19 },
  { key: "projects", name: "Projects & Explore", bucket: "Discovery", steps: ["projects_list_viewed", "project_details_viewed", "project_gallery_viewed", "project_brochure_opened", "project_enquire_now_tapped"], adoption: 71, completionRate: 29, completions: 21 },
  { key: "sitevisit", name: "Site Visits", bucket: "Discovery", steps: ["create_site_visit_opened", "site_visit_project_selected", "site_visit_date_selected", "site_visit_time_slot_selected", "site_visit_booked"], adoption: 29, completionRate: 52, completions: 16 },
  { key: "referral", name: "Referral Program", bucket: "Discovery", steps: ["referral_program_viewed", "referral_form_opened", "referral_contact_picked", "referral_submitted_success"], adoption: 17, completionRate: 41, completions: 7 },
  { key: "docs", name: "My Documents", bucket: "Support & Docs", steps: ["document_hub_viewed", "document_category_opened", "document_viewed", "document_downloaded"], adoption: 58, completionRate: 74, completions: 46 },
  { key: "servicereq", name: "Service Requests", bucket: "Support & Docs", steps: ["service_request_list_viewed", "service_request_create_opened", "service_request_category_selected", "service_request_submit_tapped", "service_request_created_success"], adoption: 49, completionRate: 63, completions: 33 },
  { key: "supportfaq", name: "Support, FAQ & Contact", bucket: "Support & Docs", steps: ["support_hub_viewed", "faq_list_viewed", "contact_us_viewed"], adoption: 38, completionRate: 47, completions: 20 },
  { key: "privilege", name: "Privilege & Concierge", bucket: "Engagement", steps: ["privilege_categories_viewed", "privilege_category_opened", "privilege_offer_details_viewed", "privilege_offer_claimed"], adoption: 34, completionRate: 33, completions: 12 },
  { key: "events", name: "Resident Events", bucket: "Engagement", steps: ["event_list_viewed", "event_details_viewed", "event_rsvp_confirmed"], adoption: 21, completionRate: 57, completions: 13 },
];
...
/* ---------------- App Stability ---------------- */
const CRASH_TILES = [
  { label: "Crash-Free Users", value: "97.8%", sub: "last 90 days, latest release" },
  { label: "Crash-Free Sessions", value: "98.4%", sub: "last 90 days, latest release" },
  { label: "Total Crashes", value: "12", sub: "last 90 days, all releases" },
  { label: "Affected Users", value: "9", sub: "distinct users who hit a crash" },
  { label: "Latest Release", value: "1.0.6 (8)", sub: "com.lockated.resident_panchshil" },
];

const CRASH_FREE_USERS_TREND = [
  { label: "Aug 8", count: 96.4 }, { label: "Aug 9", count: 97.1 }, { label: "Aug 10", count: 96.8 },
  { label: "Aug 11", count: 97.6 }, { label: "Aug 12", count: 98.0 }, { label: "Aug 13", count: 97.5 },
  { label: "Aug 14", count: 98.2 },
];
const CRASH_FREE_SESSIONS_TREND = [
  { label: "Aug 8", count: 97.2 }, { label: "Aug 9", count: 97.9 }, { label: "Aug 10", count: 97.5 },
  { label: "Aug 11", count: 98.1 }, { label: "Aug 12", count: 98.5 }, { label: "Aug 13", count: 98.0 },
  { label: "Aug 14", count: 98.7 },
];

const CRASH_ISSUES = [
  { issue: "new MultiImageStreamCompleter.<fn>", sub: "FlutterError/HttpException on image load failure — CDN asset socket abort", version: "1.0.6", events: 5, users: 3, tag: "Repetitive" },
  { issue: "CarouselSliderState.build.<fn>", sub: "RangeError (invalid length)", version: "1.0.6", events: 3, users: 2 },
  { issue: "new _VideoProgressIndicatorState.<fn>", sub: "setState/markNeedsBuild error", version: "1.0.6", events: 2, users: 1 },
  { issue: "BuildOwner.finalizeTree.<fn>", sub: "Duplicate GlobalKeys", version: "1.0.6", events: 1, users: 1 },
  { issue: "_TabBarState._handleTabControllerAnimationTick", sub: "Null check operator used on a null value", version: "1.0.6", events: 1, users: 1 },
];
...
const CRASH_VARIANTS = [
  ...
  { label: "iOS — legacy bundle (stale, no traffic)", value: 81.2, color: VIZ.brand2 },
];

const HEALTH_TILES = [
  { label: "API Timeout Rate", value: "2.6%", sub: "api_timeout ÷ all API calls" },
  { label: "Offline-Blocked Actions", value: "47", sub: "offline_action_blocked, last 90 days" },
  { label: "Rooted / Jailbroken Devices", value: "4", sub: "root_detection_triggered, distinct devices" },
  { label: "Slow API Response (p90)", value: "1,860 ms", sub: "slow_api_response, duration_ms" },
];
...
const PanchshilConnectUsageDashboard = () => {
  ...
  const filteredCrashIssues = CRASH_ISSUES.filter(
    (r) =>
      ...
      <div className="pud-shell">
        ...
        <main className="pud-main">
          ...
          {layer === "traffic" ? (
            <>
              <div className="pud-qbox">
                <b>Key questions</b>
                <ul>
                  <li>How many residents are actively using the application, and how frequently?</li>
                  <li>Which projects generate the highest traffic, and are residents returning?</li>
                </ul>
              </div>

              <SampleNote>
                Sample data shown here is illustrative and not yet wired to a live analytics source
                for Panchshil Connect. Figures will update once the traffic endpoint is connected.
              </SampleNote>
              ...
              <div className="pcd-grid" style={{ marginTop: 14 }}>
                <div className="pcd-span-2">
                  <ChartCard title="Active Users Trend" subtitle="Last 24 days">
                    <AreaChart points={ACTIVE_USERS_TREND} />
                  </ChartCard>
                </div>
                <div className="pcd-span-2">
                  <ChartCard title="Device Platform Split" subtitle="Share of active users, Android vs iOS">
                    <DonutChart rows={DEVICE_SPLIT} centerLabel="Active Users" />
                  </ChartCard>
                </div>
              </div>
            </>
              ...
              <div className="pcd-grid" style={{ marginTop: 14 }}>
                <div className="pcd-span-4">
                  <ChartCard title="Adoption Trend" subtitle="Weekly active users, last 8 weeks">
                    <AreaChart points={ADOPTION_TREND} />
                  </ChartCard>
                </div>
                ...
                <div className="pcd-span-2">
                  ...
                  >
                    <StackedShareBar rows={GROWTH_ACCOUNTING} />
                  </ChartCard>
                </div>
                <div className="pcd-span-2">
                ...
                <div className="pcd-span-2">
                  <MetricCard
                    label="Dormant Users"
                    value={312}
                    caption={`No activity 14+ days, vs. estimated ${REGISTERED_RESIDENTS.toLocaleString()} registered residents`}
                  />
                </div>
          ...
          {layer === "workflow" ? (
            <>
              <SampleNote>
                Sample data shown here is illustrative — module and event names are real, from the
                PostHog event catalogue, but adoption/completion figures are not yet wired live.
              </SampleNote>
          ...
          {layer === "stability" ? (
            <>
              <div className="pud-qbox">
                <b>Key questions</b>
                <ul>
                  <li>Is the app stable for residents on the latest release, and is stability trending up or down?</li>
                  <li>Which crashes hit the most residents, and which release or device is most affected?</li>
                </ul>
              </div>

              <SampleNote>
                Sample data shown here is illustrative and not yet wired to a live Crashlytics source
                for Panchshil Connect.
              </SampleNote>
              ...
              <div className="pcd-grid" style={{ marginTop: 14 }}>
                <div className="pcd-span-2">
                  <ChartCard title="Crash-Free Users (7-day)" subtitle="% of users with no crash, day over day">
                    <AreaChart points={CRASH_FREE_USERS_TREND} color={VIZ.brand3} />
                  </ChartCard>
                </div>
                <div className="pcd-span-2">
                  <ChartCard title="Crash-Free Sessions (7-day)" subtitle="% of sessions without a crash, day over day">
                    <AreaChart points={CRASH_FREE_SESSIONS_TREND} />
                  </ChartCard>
                </div>

                <div className="pcd-span-4">
                  <ChartCard title="Top Crash Issues" subtitle="Ranked by events over the last 90 days — search by title or file">
                    <input
                      type="text"
                      ...
                      <table className="pcd-table">
                        ...
                        <tbody>
                          {filteredCrashIssues.length === 0 ? (
                            <tr>
                              <td colSpan={4}>No issues match "{crashSearch}".</td>
                            </tr>
                          ) : (
                            filteredCrashIssues.map((r) => (
                              <tr key={r.issue}>
                                <td style={{ whiteSpace: "normal" }}>
                                  {r.issue}
                                  {r.tag ? <span className="pud-crash-tag">{r.tag}</span> : null}
                                  <span className="pud-crash-sub">{r.sub}</span>
                                </td>
                                <td>
                                  <span className="pud-crash-badge">{r.version}</span>
                                </td>
                                <td>{r.events}</td>
                                <td>{r.users}</td>
                              </tr>
                ...
                <div className="pcd-span-2">
                  <ChartCard title="Crashes by Release" subtitle="Total crash events by app version, last 90 days">
                    <HBar rows={[{ key: "1.0.6", label: "1.0.6 (8)", value: 12 }]} color={VIZ.brand2} />
                  </ChartCard>
                </div>
                <div className="pcd-span-2">
                  <ChartCard title="Crash-Free Users by App Variant" subtitle="By registered app variant / OS">
                    <PercentHBar rows={CRASH_VARIANTS} color={VIZ.brand3} />
                  </ChartCard>
                </div>
              </div>
              ...
              <div className="pcd-grid" style={{ marginTop: 14 }}>
                <div className="pcd-span-4">
                  ...
                  >
                    <HBar rows={FAILURES_BY_MODULE} color="#c98a12" />
                  </ChartCard>
                </div>
              </div>
            </>
